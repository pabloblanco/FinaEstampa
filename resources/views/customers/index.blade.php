                                        ...
                                        <table class="table table-striped" id="example2" >
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>{{ $customer->fechaDeNacimiento }}</td>
                                                    <td>{{ $customer->sexo }}</td>
                                                    <td>
                                                        @if(($customer->inscritoABoletin == "NO") OR ($customer->inscritoABoletin == "no") )
                                                            <span class="badge badge-md badge-danger">{{ $customer->inscritoABoletin }}</span>
                                                        @else
                                                            <span class="badge badge-md badge-success">{{ $customer->inscritoABoletin }}</span>
                                                        @endif
                                                    </td> 
                                                    <td>
                                                        @if(($customer->recibeNotificacionesYPromos == "NO") OR ($customer->recibeNotificacionesYPromos == "no") )
                                                            <span class="badge badge-md badge-danger">{{ $customer->recibeNotificacionesYPromos }}</span>
                                                        @else
                                                            <span class="badge badge-md badge-success">{{ $customer->recibeNotificacionesYPromos }}</span>
                                                        @endif
                                                    </td>                                                     
                                                    <td>
                                                        <a href="/admin/public/masters/{{ $customer->id }}" class="btn btn-primary">
                                                            <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                                                        </a>
                                                        <a id="{{ $customer->id }}" href="#ultraModal-1" data-toggle="modal" class="edition2 btn btn-danger">
