                ...
                <div class='pull-right'>
                    <ul class="info-menu right-links list-inline list-unstyled">
                        <li class="profile">
                            ...
                            <a href="{{ route('login') }}">{{ __('Login') }} <i class="fa fa-unlock"></i></a>
                            @if (Route::has('register'))
                                <a class="nav-link" href="{{ route('register') }}">&nbsp&nbsp{{ __('Register') }}</a>
                            @endif
                @else
                    <ul class="info-menu left-links list-inline list-unstyled">
                        ...
                        <li class="">
                            ...
                            <ul class="dropdown-menu messages animated fadeIn">
                                ...
                                <li class="external">
                                    <a href="javascript:;">
                                        <span>LEER TODOS LOS MENSAJES</span>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="">
                            ...
                            <ul class="dropdown-menu notifications animated fadeIn">
                                <li class="total">
                                    <span class="small">
                                        Tienes <strong>3</strong> notificaciones nuevas.
                                        <a href="javascript:;" class="pull-right">Marcar como leidas</a>
                                    </span>
                                </li>
                                <li class="list">
                                ...
                                <li class="external">
                                    <a href="javascript:;">
                                        <span>LEER TODAS LAS NOTIFICACIONES</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="hidden-sm hidden-xs searchform">
                            <div class="input-group">
                                ...
                                <form action="#" method="post">
                                    <input type="text" class="form-control animated fadeIn" placeholder="Buscar">
