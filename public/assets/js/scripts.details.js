            ...
            $(document).ready(function() {
                ...
                $('.edition2').on('click', function() {
                    ...
                    function fnFormatDetails(oTable, nTr) {
                        ...
                        var url = "/admin/public/details/" + aData[1] + "/modal";
                ...
                $('#example2 tbody td i').on('click', function() {
                    ...
                    function fnFormatDetails(oTable, nTr) {
                        var aData = oTable.fnGetData(nTr);
                        var sOut = '<table id="reemplazar-' + aData[1] + '" cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;" class="inner-table"><tr><td></td></tr></table>';
                        var xmlhttp = new XMLHttpRequest();
                        var url = "/admin/public/details/" + aData[1] + "/show";
