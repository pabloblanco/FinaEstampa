        ...
        if ($.isFunction($.fn.dataTable)) {
            ...
            $(document).ready(function() {
                ...
                var oTable = $('#example2').dataTable({
                    ...
                    "oLanguage": {
                        "sLengthMenu": "_MENU_ ",
                        "sInfo": "Muestra _START_ a _END_ de _TOTAL_ usuarios"                      
                    },
                });
                ...
                $('.edition2').on('click', function() {
                    ...
                    function fnFormatDetails(oTable, nTr) {
                        ...
                        var sOut = '<table id="reemplazar-' + aData[1] + '" cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;" class="inner-table"></table>';

                        var xmlhttp = new XMLHttpRequest();
                        var url = "Consulta.php?id=" + aData[1];
                        xmlhttp.onreadystatechange=function() {
                            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                                var array = JSON.parse(xmlhttp.responseText);
                                console.log(JSON.parse(xmlhttp.responseText));

                                //Tabla usuario: `id`, `usuario`, `apellido`, `fechaDeNacimiento`, `sexo`, `email`, `contrasena`, `inscritoABoletin`, 
                                //`recibeNotificacionesYPromos`, `imgUsuario`, `facturacionElectronica`, `razonSocial`, `RFC`, `user_type`

                                //Tabla direcciondeenvio: `idDireccionDeEnvio`, `idUsuario`, `nombrePersonaDireccionDeEnvio`, `apellidosPersonaDireccionDeEnvio`, 
                                //`calleDireccionDeEnvio`, `numeroExteriorDireccionDeEnvio`, `numeroInteriorDireccionDeEnvio`, `coloniaDireccionDeEnvio`, 
                                //`ciudadDireccionDeEnvio`, `codigoPostalDireccionDeEnvio`, `paisDireccionDeEnvio`, `estadoDireccionDeEnvio`, `numeroTelefonoDireccionDeEnvio`

                                //Tabla direcciondefacturacion: `idDireccionFacturacion`, `idUsuario`, `nombredireccionDeFacturacion`, `apellidosdireccionDeFacturacion`, 
                                ...
                                sOut  = '<div class="row">';
                                sOut += '   <div class="form-group col-xs-6">';                                
                                sOut += '       <h4 class="modal-title">Dirección de envío</h4>';    
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-6">';                                
                                sOut += '       <h4 class="modal-title">Dirección de facturación</h4>';    
                                sOut += '   </div>';                                
                                sOut += '</div>'; 
                                sOut += '<div class="row">';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Quién recibe:</label>';
                                sOut += '       <input type="hidden" name="idUsuario" class="form-control" value="' + array[0].idUsuario + '">';
                                sOut += '       <input type="text" name="nombrePersonaDireccionDeEnvio" class="form-control" placeholder="Ingrese el nombre" value="' + array[0].nombrePersonaDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Colonia:</label>';
                                sOut += '       <input type="text" name="coloniaDireccionDeEnvio" class="form-control" placeholder="Ingrese la colonia" value="' + array[0].coloniaDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Quién factura:</label>';
                                sOut += '       <input type="text" name="nombredireccionDeFacturacion" class="form-control" placeholder="Ingrese el nombre" value="' + array[0].nombredireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Colonia:</label>';
                                sOut += '       <input type="text" name="coloniaDireccionDeFacturacion" class="form-control" placeholder="Ingrese la colonia" value="' + array[0].coloniaDireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '</div>';   
                                sOut += '<div class="row">';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Teléfono:</label>';
                                sOut += '       <input type="text" name="numeroTelefonoDireccionDeEnvio" class="form-control" placeholder="Ingrese el teléfono" value="' + array[0].numeroTelefonoDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>CP:</label>';
                                sOut += '       <input type="text" name="codigoPostalDireccionDeEnvio" class="form-control" placeholder="Ingrese el código postal" value="' + array[0].codigoPostalDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Teléfono:</label>';
                                sOut += '       <input type="text" name="numeroTelefonoDireccionDeFacturacion" class="form-control" placeholder="Ingrese el teléfono" value="' + array[0].numeroTelefonoDireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>CP:</label>';
                                sOut += '       <input type="text" name="codigoPostalDireccionDeFacturacion" class="form-control" placeholder="Ingrese el código postal" value="' + array[0].codigoPostalDireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '</div>';  
                                sOut += '<div class="row">';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Dirección:</label>';
                                sOut += '       <input type="text" name="calleDireccionDeEnvio" class="form-control" placeholder="Ingrese la calle" value="' + array[0].calleDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Ciudad:</label>';
                                sOut += '       <input type="text" name="ciudadDireccionDeEnvio" class="form-control" placeholder="Ingrese la ciudad" value="' + array[0].ciudadDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Dirección:</label>';
                                sOut += '       <input type="text" name="calleDireccionDeFacturacion" class="form-control" placeholder="Ingrese la calle" value="' + array[0].calleDireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Ciudad:</label>';
                                sOut += '       <input type="text" name="ciudadDireccionDeFacturacion" class="form-control" placeholder="Ingrese la ciudad" value="' + array[0].ciudadDireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '</div>';  
                                sOut += '<div class="row">';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Exterior:</label>';
                                sOut += '       <input type="text" name="numeroExteriorDireccionDeEnvio" class="form-control" placeholder="Ingrese el número exterior" value="' + array[0].numeroExteriorDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Estado:</label>';
                                sOut += '       <input type="text" name="estadoDireccionDeEnvio" class="form-control" placeholder="Ingrese el estado" value="' + array[0].estadoDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Exterior:</label>';
                                sOut += '       <input type="text" name="numeroExteriorDireccionDeFacturacion" class="form-control" placeholder="Ingrese el número exterior" value="' + array[0].numeroExteriorDireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Estado:</label>';
                                sOut += '       <input type="text" name="estadoDireccionDeFacturacion" class="form-control" placeholder="Ingrese el estado" value="' + array[0].estadoDireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '</div>';
                                sOut += '<div class="row">';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Interior:</label>';
                                sOut += '       <input type="text" name="numeroInteriorDireccionDeEnvio" class="form-control" placeholder="Ingrese el número interior" value="' + array[0].numeroInteriorDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Pais:</label>';
                                sOut += '       <input type="text" name="paisDireccionDeEnvio" class="form-control" placeholder="Ingrese el pais" value="' + array[0].paisDireccionDeEnvio + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Interior:</label>';
                                sOut += '       <input type="text" name="numeroInteriorDireccionDeFacturacion" class="form-control" placeholder="Ingrese el número interior" value="' + array[0].numeroInteriorDireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Pais:</label>';
                                sOut += '       <input type="text" name="paisDireccionDeFacturacion" class="form-control" placeholder="Ingrese el pais" value="' + array[0].paisDireccionDeFacturacion + '">';
                                sOut += '   </div>';
                                sOut += '</div>';

                                sOut += '<div class="row">';
                                sOut += '   <div class="form-group col-xs-12">';                                
                                sOut += '       <h4 class="modal-title">Información de facturación</h4>';    
                                sOut += '   </div>';
                                sOut += '</div>';  
                                sOut += '<div class="row">';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Facturación:</label>';
                                sOut += '       <input type="text" name="numeroInteriorDireccionDeEnvio" class="form-control" placeholder="Requiere facturación" value="' + array[0].facturacionElectronica + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Razón:</label>';
                                sOut += '       <input type="text" name="razonSocial" class="form-control" placeholder="Ingrese la razón social" value="' + array[0].razonSocial + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>RFC:</label>';
                                sOut += '       <input type="text" name="RFC" class="form-control" placeholder="Ingrese el RFC" value="' + array[0].RFC + '">';
                                sOut += '   </div>';
                                sOut += '   <div class="form-group col-xs-3">';
                                sOut += '       <label>Email:</label>';
                                sOut += '       <input type="text" name="correoElectronicodireccionDeFacturacion" class="form-control" placeholder="Ingrese email para factura" value="' + array[0].correoElectronicodireccionDeFacturacion + '">';
                                sOut += '   </div>';                                
                                sOut += '</div>';                                

                                // sOut  = '<table id="reemplazar-' + array[0].id + '" cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;" class="inner-table">';
                                // sOut += '<tr><td><b>Dirección de Envío</b></td><td></td><td><b>Dirección de Facturación</b></td><td></td><td><b>Contacto</b></td></tr>';
                                // sOut += '<tr><td>Email: <input class="form-control m-bot15" type="text" placeholder="' + array[0].email + '"></td><td>Colonia: <input class="form-control m-bot15" type="text" placeholder="' + array[0].coloniaDireccionDeEnvio + '"></td><td></td><td></td></tr>';
                                // sOut += '<tr><td>Teléfono: <input class="form-control m-bot15" type="text" placeholder="' + array[0].numeroTelefonoDireccionDeEnvio + '"></td><td>CP: <input class="form-control m-bot15" type="text" placeholder="' + array[0].codigoPostalDireccionDeEnvio + '"></td><td></td><td></td></tr>';
                                // sOut += '<tr><td>Dirección: <input class="form-control m-bot15" type="text" placeholder="' + array[0].calleDireccionDeEnvio + '"></td><td>Ciudad: <input class="form-control m-bot15" type="text" placeholder="' + array[0].ciudadDireccionDeEnvio + '"></td><td></td><td></td></tr>';
                                // sOut += '<tr><td>Exterior: <input class="form-control m-bot15" type="text" placeholder="' + array[0].numeroExteriorDireccionDeEnvio + '"></td><td>Estado: <input class="form-control m-bot15" type="text" placeholder="' + array[0].estadoDireccionDeEnvio + '"></td><td></td><td></td></tr>';
                                // sOut += '<tr><td>Interior: <input class="form-control m-bot15" type="text" placeholder="' + array[0].numeroInteriorDireccionDeEnvio + '"></td><td>Pais: <input class="form-control m-bot15" type="text" placeholder="' + array[0].paisDireccionDeEnvio + '"></td><td></td><td></td></tr>';
                                // sOut += '<tr><td><b>Facturación</b></td><td></td><td><b></b></td><td><b></b></td></tr>';
                                // sOut += '<tr><td><b>Facturación:</b> <input class="form-control m-bot15" type="text" placeholder="' + array[0].facturacionElectronica + '"></td><td><b>Razón: </b><input class="form-control m-bot15" type="text" placeholder="' + array[0].razonSocial + '"></td><td></td><td><b>RFC: </b><input class="form-control m-bot15" type="text" placeholder="' + array[0].RFC + '"></td><td><b>Email: </b><input class="form-control m-bot15" type="text" placeholder="' + array[0].correoElectronicodireccionDeFacturacion + '"></td></tr>';
                                // sOut += '</table>';

                                document.getElementById("innerUltraModal-1").innerHTML = sOut;
                            }
                        }
                ...
                $('#example2 tbody td i').on('click', function() {
                    ...
                    function fnFormatDetails(oTable, nTr) {
                        ...
                        var url = "/admin/public/customers/" + aData[1] + "/show";
                        xmlhttp.onreadystatechange=function() {
                            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                                sOut  = xmlhttp.responseText;
                                document.getElementById("reemplazar-" + aData[1]).innerHTML = sOut;
                            }
                        }
                        ...
                        //         console.log(JSON.parse(xmlhttp.responseText));
                                ...
                                // sOut += '<tr><td>Email: ' + array[0].email + '</td><td>Colonia: ' + array[0].coloniaDireccionDeEnvio + '</td><td>Nombres: ' + array[0].nombredireccionDeFacturacion + '</td><td>Colonia: ' + array[0].coloniaDireccionDeFacturacion + '</td></tr>';
                                // sOut += '<tr><td>Teléfono: ' + array[0].numeroTelefonoDireccionDeEnvio + '</td><td>CP: ' + array[0].codigoPostalDireccionDeEnvio + '</td><td>Teléfono: ' + array[0].numeroTelefonoDireccionDeFacturacion + '</td><td>CP: ' + array[0].codigoPostalDireccionDeFacturacion + '</td></tr>';
                                // sOut += '<tr><td>Dirección: ' + array[0].calleDireccionDeEnvio + '</td><td>Ciudad: ' + array[0].ciudadDireccionDeEnvio + '</td><td>Dirección: ' + array[0].calleDireccionDeFacturacion + '</td><td>Ciudad: ' + array[0].ciudadDireccionDeFacturacion + '</td></tr>';
                                // sOut += '<tr><td>Exterior: ' + array[0].numeroExteriorDireccionDeEnvio + '</td><td>Estado: ' + array[0].estadoDireccionDeEnvio + '</td><td>Exterior: ' + array[0].numeroExteriorDireccionDeFacturacion + '</td><td>Estado: ' + array[0].estadoDireccionDeFacturacion + '</td></tr>';
                                // sOut += '<tr><td>Interior: ' + array[0].numeroInteriorDireccionDeEnvio + '</td><td>Pais: ' + array[0].paisDireccionDeEnvio + '</td><td>Interior: ' + array[0].numeroInteriorDireccionDeFacturacion + '</td><td>Pais: ' + array[0].paisDireccionDeFacturacion + '</td></tr>';
           
                                // sOut += '<tr><td><b>Facturación</b></td><td></td><td><b></b></td><td><b></b></td></tr>';
                                // sOut += '<tr><td><b>Facturación:</b> ' + array[0].facturacionElectronica + '</td><td><b>Razón: </b>' + array[0].razonSocial + '</td><td></td><td><b>RFC:</b>' + array[0].RFC + '</td><td><b>Email:</b>' + array[0].correoElectronicodireccionDeFacturacion + '</td></tr>';
                                // sOut += '</table>';
