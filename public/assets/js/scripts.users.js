            ...
            $(document).ready(function() {
                ...
                $('#example2 tbody td i').on('click', function() {
                    ...
                    function fnFormatDetails(oTable, nTr) {
                        ...
                        sOut += '<tr><td>Email:</td><td>' + aData[1] + ' ' + aData[4] + '</td><td>Colonia:</td><td>' + aData[1] + ' ' + aData[4] + '</td></tr>';
                        sOut += '<tr><td>Teléfono:</td><td>Could provide a link here</td><td>CP:</td><td>' + aData[1] + ' ' + aData[4] + '</td></tr>';
                        sOut += '<tr><td>Dirección:</td><td>And any further details here (images etc)</td><td>Ciudad:</td><td>' + aData[1] + ' ' + aData[4] + '</td></tr>';
                        sOut += '<tr><td>Interior:</td><td>Could provide a link here</td><td>Estado:</td><td>' + aData[1] + ' ' + aData[4] + '</td></tr>';
                        sOut += '<tr><td>Exterior:</td><td>And any further details here (images etc)</td><td>Pais:</td><td>' + aData[1] + ' ' + aData[4] + '</td></tr>';
                        sOut += '<tr><td><b>Facturación</b></td><td></td><td><b></b></td><td><b></b></td></tr>';
                        sOut += '<tr><td>Facturación: SI</td><td>Razón:</td><td></td><td>RFC:</td><td><b>Email:</b></td></tr>';
                        sOut += '</table>';
