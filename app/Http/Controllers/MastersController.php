...
/*        $total_users = User::get()->count();
    ...
    public function receiveData(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $mensaje = "Se modificó el registro de la orden ".$idOrden;
    ...
    public function showDataModal($id)
    {
        ...
        $sOut = $sOut.'       <input type="text" name="codigoPostalDireccionDeEnvio" class="form-control" placeholder="Ingrese el código postal" value="'.$masters[0]->codigoPostalDireccionDeEnvio.'">';
        $sOut = $sOut.'   </div>';
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
        $sOut = $sOut.'       <label>Apellido:</label>';
        ...
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
        $sOut = $sOut.'       <label>C.P.:</label>';
        $sOut = $sOut.'       <input type="text" name="codigoPostalDireccionDeFacturacion" class="form-control" placeholder="Ingrese el código postal" value="'.$masters[0]->codigoPostalDireccionDeFacturacion.'">';
        $sOut = $sOut.'   </div>';
        $sOut = $sOut.'</div>';  
        ...
        $sOut = $sOut.'       <input type="text" name="numeroInteriorDireccionDeEnvio" class="form-control" placeholder="Ingrese el número interior" value="'.$masters[0]->numeroInteriorDireccionDeEnvio.'">';
        $sOut = $sOut.'   </div>';
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
        ...
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
        $sOut = $sOut.'       <label>Interior:</label>';
        $sOut = $sOut.'       <input type="text" name="numeroInteriorDireccionDeFacturacion" class="form-control" placeholder="Ingrese el número interior" value="'.$masters[0]->numeroInteriorDireccionDeFacturacion.'">';
        $sOut = $sOut.'   </div>';
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
        $sOut = $sOut.'       <label>Estado:</label>';
        ...
        $sOut = $sOut.'       <input type="text" name="numeroExteriorDireccionDeEnvio" class="form-control" placeholder="Ingrese el número exterior" value="'.$masters[0]->numeroExteriorDireccionDeEnvio.'">';
        $sOut = $sOut.'   </div>';
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
        ...
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
        $sOut = $sOut.'       <label>Exterior:</label>';
        $sOut = $sOut.'       <input type="text" name="numeroExteriorDireccionDeFacturacion" class="form-control" placeholder="Ingrese el número exterior" value="'.$masters[0]->numeroExteriorDireccionDeFacturacion.'">';
        $sOut = $sOut.'   </div>';
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
        $sOut = $sOut.'       <label>País:</label>';
        ...
        $sOut = $sOut.'       <input type="text" name="numeroTelefonoDireccionDeEnvio" class="form-control" placeholder="Ingrese el teléfono" value="'.$masters[0]->numeroTelefonoDireccionDeEnvio.'">';
        $sOut = $sOut.'   </div>';
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
        ...
        $sOut = $sOut.'       <input type="text" name="RazonSocialdireccionDeFacturacion" class="form-control" placeholder="Ingrese la Razón Social" value="'.$masters[0]->RazonSocialdireccionDeFacturacion.'">';
        $sOut = $sOut.'   </div>';         
        $sOut = $sOut.'   <div class="form-group col-xs-3">';
